...
In this hands-on exercise, I will create interactive data visualisation by using functions provided by ggiraph and plotly packages.
...
![](Hands-on%20Exercises/Hands-on%20W3/image2.jpg)
...
This [link](https://davidgohel.github.io/ggiraph/) provides online version of the reference guide and several useful articles. Use this [link](https://cran.r-project.org/package=ggiraph) to download the pdf version of the reference guide.

-   [How to Plot With Ggiraph](https://davidgohel.github.io/ggiraph/)
-   [Interactive map of France with ggiraph](https://davidgohel.github.io/ggiraph/)
-   [Custom interactive sunbursts with ggplot in R](https://www.r-bloggers.com/2019/06/custom-interactive-sunbursts-with-ggplot-in-r/)
-   This [link](https://davidgohel.github.io/ggiraph/) provides code example on how ggiraph is used to interactive graphs for [Swiss Olympians - the solo specialists](https://swissolympians.app/)
...
-   [Plotly R Figure Reference](https://plotly.com/r/reference/) provides a comprehensive discussion of each visual representations.
-   [Plotly R Library Fundamentals](https://plotly.com/r/) is a good place to learn the fundamental features of Plotly’s R API.
-   [Getting Started](https://plotly.com/r/getting-started/)
-   Visit this [link](https://r-graph-gallery.com/animation.html) for a very interesting implementation of gganimate by your senior.
-   [Building an animation step-by-step with gganimate](https://www.data-imaginist.com/2019/gganimate-has-transitioned-to-a-state-of-release/)
-   [Creating a composite gif with multiple gganimate panels](https://www.tidyverse.org/blog/2019/04/gganimate-1-0-0/)

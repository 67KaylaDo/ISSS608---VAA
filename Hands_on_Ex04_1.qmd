...
Visualising data distributions isn’t new in statistical analysis. In Chapter 1, I covered some of the most commonly used methods: histograms, probability density curves (PDFs), boxplots, notch plots, and violin plots, and showed how to create them using [ggplot2]{.underline}.

In this chapter, I’m introducing two more modern approaches: **ridgeline plots** and **raincloud plots**. These techniques offer richer and more intuitive ways to explore distributions, and I’ll walk through how to build them using ggplot2 and its extensions.

...
::: {style="text-align: center; font-size: 2rem; margin: 1.5rem 0;"}
...
![](Hands-on%20Exercises/Hands-on%20W1/image4.jpg)
...
![Examples of ggplot2 geoms](Hands-on%20Exercises/Hands-on%20W1/image6.jpg)
...
scale_y_continuous() is used to turn off the y-axis binwidth argument is used to change the binwidth to 2.5
:::
...
In the code chunk below, - bins argument is used to change the number of bins to 20 - fill argument is used to shade the histogram - color argument is used to change the outline colour
...
Notched boxplot: Notches are used in box plots to help visually assess whether the medians of distributions differ. If the notches do not overlap, this is evidence that the medians are different.
